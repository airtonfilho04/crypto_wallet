class CoinsController < ApplicationController
  ...
  before_action :show_mining_type_options, only: [:new, :create, :edit, :update]
  ...
  private
    ...
    def show_mining_type_options
      @show_mining_type_options = MiningType.all.pluck(:description, :id)
    end
